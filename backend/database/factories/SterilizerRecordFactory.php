...
/**
 * @extends Factory<SterilizerRecord>
 *
 * Test infrastructure for screen-124--data-browser-sterilizer-web.
 * Mirrors CpoDispatchRecordFactory's structure. SterilizerRecord has no
 * `saving` guard hook (see the model's own docblock), so ::Saved is a
 * safe default even with zero related detail rows.
 */
class SterilizerRecordFactory extends Factory
{
    protected $model = SterilizerRecord::class;
    ...
    public function definition(): array
    {
        ...
        return [
            'station_id' => Station::factory()->sterilizer(),
            'sterilizer_id' => 'STR-'.$this->faker->unique()->numerify('####-####'),
