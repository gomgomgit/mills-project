...
<head>
    ...
    <title>Data Browser Grading — Mills Smart Log</title>
    ...
    <style>
        /* Design tokens — uiux-spec: brand #249360, Inter. Inlined here (same
           approach as resources/views/data/weighbridge.blade.php) since this
           backend scaffold has no frontend build pipeline yet — see
           implementation_notes. This file is this screen's #[Layout(...)]
           shell (sidebar + header), mirroring screen-016's
           data/weighbridge.blade.php pattern rather than reusing it
           directly (no shared shell layout component exists yet in this
...
<body>
    <aside class="shell-sidebar">
        ...
        <ul class="shell-sidebar__nav">
            ...
            <li><a href="{{ route('data.grading') }}" class="active">Data Browser Grading</a></li>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Data Browser Grading</h1>
            @auth
