...
/**
 * Process Water Record — log-sheet header entry for the ProcessWater station; has many ProcessWaterDetail.
 *
 ...
 */
class ProcessWaterRecord extends Model
{
    ...
    public function processWaterDetails(): HasMany
    {
        return $this->hasMany(ProcessWaterDetail::class);
    }
}
