...
<head>
    ...
    <title>Kelola Station — Mills Smart Log</title>
    ...
    <style>
        /* Design tokens — uiux-spec: brand #249360, Inter. Inlined here (same
           approach as resources/views/master-data/business-units.blade.php
           ...
           resources/views/master-data/business-units.blade.php's pattern
...
<body>
    <aside class="shell-sidebar">
        ...
        <ul class="shell-sidebar__nav">
            ...
            <li><a href="{{ route('master-data.stations') }}" class="active">Kelola Station</a></li>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Kelola Station</h1>
            @auth
