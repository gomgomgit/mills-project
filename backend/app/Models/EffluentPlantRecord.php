...
/**
 * Effluent Plant Record — log-sheet header entry for the EffluentPlant station; has many EffluentPlantDetail.
 *
 ...
 */
class EffluentPlantRecord extends Model
{
    ...
    public function effluentPlantDetails(): HasMany
    {
        return $this->hasMany(EffluentPlantDetail::class);
    }
}
