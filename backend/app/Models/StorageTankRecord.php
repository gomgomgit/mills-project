...
/**
 * Storage Tank Record — log-sheet header entry for the StorageTank station; has many StorageTankDetail.
 *
 ...
 */
class StorageTankRecord extends Model
{
    ...
    public function storageTankDetails(): HasMany
    {
        return $this->hasMany(StorageTankDetail::class);
    }
}
