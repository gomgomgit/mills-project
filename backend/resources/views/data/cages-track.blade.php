...
<head>
    ...
    <title>Data Browser Cages Track — Mills Smart Log</title>
    ...
    <style>
        /* Design tokens — uiux-spec: brand #249360, Inter. Inlined here (same
           approach as resources/views/data/grading.blade.php) since this
           backend scaffold has no frontend build pipeline yet — see
           implementation_notes. This file is this screen's #[Layout(...)]
           shell (sidebar + header), mirroring screen-017's
           data/grading.blade.php pattern rather than reusing it directly
           (no shared shell layout component exists yet in this codebase to
           extract into — see implementation_notes). */
        :root {
            --color-brand: #249360;
...
<body>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Data Browser Cages Track</h1>
            @auth
