...
<head>
    ...
    <title>Kelola Machinery — Mills Smart Log</title>
    ...
    <style>
        /* Design tokens — uiux-spec: brand #249360, Inter. Inlined here (same
           approach as resources/views/master-data/machinery-groups.blade.php
           and every other shell layout in this codebase) since this backend
           scaffold has no frontend build pipeline yet. This file is this
           screen's #[Layout(...)] shell (sidebar + header), mirroring
           machinery-groups.blade.php's pattern exactly. */
        :root {
            --color-brand: #249360;
...
<body>
    <aside class="shell-sidebar">
        ...
        <ul class="shell-sidebar__nav">
            ...
            <li><a href="{{ route('master-data.machinery') }}" class="active">Kelola Machinery</a></li>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Kelola Machinery</h1>
            @auth
