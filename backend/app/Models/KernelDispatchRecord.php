...
/**
 * Kernel Dispatch Record — log-sheet header entry for the KernelDispatch station; has many KernelDispatchDetail.
 *
 ...
 */
class KernelDispatchRecord extends Model
{
    ...
    public function kernelDispatchDetails(): HasMany
    {
        return $this->hasMany(KernelDispatchDetail::class);
    }
}
