...
<head>
    ...
    <title>Detail Grading — Mills Smart Log</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    @livewireStyles
    <style>
        /* Design tokens — same shell pattern as resources/views/data/weighbridge-detail.blade.php
           (screen-019's own #[Layout(...)] shell) — this screen (screen-020)
           gets its own layout file rather than reusing screen-019's/screen-017's
           directly since the header title differs and Blade layouts don't take params. */
        :root {
            --color-brand: #249360;
...
<body>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Detail Grading</h1>
            @auth
