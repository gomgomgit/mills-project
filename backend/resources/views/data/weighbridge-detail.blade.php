...
<head>
    ...
    <title>Detail Weighbridge — Mills Smart Log</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    @livewireStyles
    <style>
        /* Design tokens — same shell pattern as resources/views/data/weighbridge.blade.php
           (screen-016's own #[Layout(...)] shell) — this screen (screen-019)
           gets its own layout file rather than reusing screen-016's directly
...
<body>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Detail Weighbridge</h1>
            @auth
