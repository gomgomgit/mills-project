...
<head>
    ...
    <title>Form Cages Track — Mills Smart Log</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    @livewireStyles
    <style>
        /* Design tokens — same shell pattern as resources/views/data/grading-form.blade.php
           (screen-023's own #[Layout(...)] shell). This screen (screen-024)
           gets its own layout file rather than reusing screen-023's directly
...
<body>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Form Cages Track</h1>
            @auth
