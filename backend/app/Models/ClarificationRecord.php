...
/**
 * Clarification Record — log-sheet header entry for the Clarification station; has many ClarificationDetail.
 *
 ...
 */
class ClarificationRecord extends Model
{
    ...
    public function clarificationDetails(): HasMany
    {
        return $this->hasMany(ClarificationDetail::class);
    }
}
