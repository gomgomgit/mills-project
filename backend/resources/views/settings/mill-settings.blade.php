...
<head>
    ...
    <title>Mills Setting — Mills Smart Log</title>
    ...
    <style>
        /* Design tokens — uiux-spec: brand #249360, Inter. Inlined here (same
           approach as resources/views/master-data/machinery.blade.php and
           ...
           machinery.blade.php's pattern exactly. */
        :root {
            --color-brand: #249360;
...
<body>
    <aside class="shell-sidebar">
        ...
        <ul class="shell-sidebar__nav">
            ...
            <li><a href="{{ route('mill-settings') }}" class="active">Mills Setting</a></li>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Mills Setting</h1>
            @auth
