...
/**
 * CPO Dispatch Record — log-sheet header entry for the CpoDispatch station; has many CpoDispatchDetail.
 *
 ...
 */
class CpoDispatchRecord extends Model
{
    ...
    public function cpoDispatchDetails(): HasMany
    {
        return $this->hasMany(CpoDispatchDetail::class);
    }
}
