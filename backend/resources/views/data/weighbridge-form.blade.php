...
<head>
    ...
    <title>Form Weighbridge — Mills Smart Log</title>
    ...
    <style>
        /* Design tokens — same shell pattern as resources/views/data/weighbridge-detail.blade.php
           (screen-019's own #[Layout(...)] shell) — this screen (screen-022)
           gets its own layout file rather than reusing screen-019's directly
           since the header title differs and Blade layouts don't take params. */
        :root {
            --color-brand: #249360;
...
<body>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Form Weighbridge</h1>
            @auth
