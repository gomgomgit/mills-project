...
<head>
    ...
    <title>Data Browser Weighbridge — Mills Smart Log</title>
    ...
    <style>
        /* Design tokens — uiux-spec: brand #249360, Inter. Inlined here (same
           approach as resources/views/settings/password.blade.php and
           resources/views/auth/login.blade.php) since this backend scaffold
           has no frontend build pipeline yet — see implementation_notes.
           This file is this screen's #[Layout(...)] shell (sidebar + header),
           mirroring the settings/password.blade.php pattern rather than
           reusing it directly (no shared shell layout component exists yet
           in this codebase to extract into — see implementation_notes). */
        :root {
            --color-brand: #249360;
...
<body>
    <aside class="shell-sidebar">
        ...
        <ul class="shell-sidebar__nav">
            ...
            <li><a href="{{ route('data.weighbridge') }}" class="active">Data Browser Weighbridge</a></li>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Data Browser Weighbridge</h1>
            @auth
