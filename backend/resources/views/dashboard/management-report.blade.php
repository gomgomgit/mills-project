...
<head>
    ...
    <title>Laporan Manajemen — Mills Smart Log</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    @livewireStyles
    <style>
        /* Shell for screen-026--laporan-manajemen. Styles copied verbatim
           from resources/views/dashboard/index.blade.php (this codebase's
           shared shell pattern; no extracted layout component exists
           yet). */
        :root {
            --color-brand: #249360;
...
<body>
    <aside class="shell-sidebar">
        ...
        <ul class="shell-sidebar__nav">
            ...
            <li><a href="{{ route('reports.management') }}" class="active">Laporan Manajemen</a></li>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Laporan Manajemen</h1>
            @auth
