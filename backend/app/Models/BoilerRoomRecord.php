...
/**
 * Boiler Room Record — log-sheet header entry for the BoilerRoom station; has many BoilerRoomDetail.
 *
 ...
 */
class BoilerRoomRecord extends Model
{
    ...
    public function boilerRoomDetails(): HasMany
    {
        return $this->hasMany(BoilerRoomDetail::class);
    }
}
