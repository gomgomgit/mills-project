...
<head>
    ...
    <title>Kelola User & Role — Mills Smart Log</title>
...
<body>
    <aside class="shell-sidebar">
        ...
        <ul class="shell-sidebar__nav">
            ...
            <li><a href="{{ route('users.index') }}" class="active">Kelola User & Role</a></li>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Kelola User & Role</h1>
            @auth
