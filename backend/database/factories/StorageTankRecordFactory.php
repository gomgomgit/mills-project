...
/**
 * @extends Factory<StorageTankRecord>
 *
 ...
 * Mirrors EffluentPlantRecordFactory.php's exact structure/conventions.
 *
 * Default status is RecordStatus::Synced, deliberately NOT ::Saved: a
 * record created fresh via this factory (no related StorageTankDetail rows
 ...
 * EffluentPlantRecordFactory even though StorageTankRecord's own model
 * comment notes this guard is intentionally NOT implemented for this
 * entity).
 */
class StorageTankRecordFactory extends Factory
{
    protected $model = StorageTankRecord::class;
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'storage_tank_id' => 'ST-'.$this->faker->unique()->numerify('####'),
