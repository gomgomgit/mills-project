...
/**
 * DataBrowserSolidWasteDisposal — screen-091--data-browser-solid-waste-disposal-web
 * (Livewire web page, route name `data.solid-waste-disposal`,
 * /data/solid-waste-disposal). Mirrors DataBrowserCagesTrack exactly.
 */
#[Layout('data.solid-waste-disposal')]
class DataBrowserSolidWasteDisposal extends Component
{
    ...
    protected function exportUrl(string $format): string
    {
        ...
        return url('/api/solid-waste-disposal-records/export').'?'.http_build_query($query);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.data.data-browser-solid-waste-disposal', [
            'records' => $result['data'],
            'meta' => $result['meta'],
