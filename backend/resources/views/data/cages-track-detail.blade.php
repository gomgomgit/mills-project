...
<head>
    ...
    <title>Detail Cages Track — Mills Smart Log</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    @livewireStyles
    <style>
        /* Design tokens — same shell pattern as resources/views/data/grading-detail.blade.php
           (screen-020's own #[Layout(...)] shell) — this screen (screen-021)
           gets its own layout file rather than reusing screen-020's/screen-018's
...
<body>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Detail Cages Track</h1>
            @auth
