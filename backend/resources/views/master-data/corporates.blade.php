...
<head>
    ...
    <title>Kelola Corporate — Mills Smart Log</title>
    ...
    <style>
        /* Design tokens — uiux-spec: brand #249360, Inter. Inlined here (same
           ...
           other shell layout in this codebase) since this backend scaffold
           has no frontend build pipeline yet — see implementation_notes.
           This file is this screen's #[Layout(...)] shell (sidebar +
           header), mirroring resources/views/data/weighbridge.blade.php's
           pattern exactly (no shared shell layout component exists yet in
           this codebase to extract into — see implementation_notes). */
        :root {
            --color-brand: #249360;
...
<body>
    <aside class="shell-sidebar">
        ...
        <ul class="shell-sidebar__nav">
            ...
            <li><a href="{{ route('master-data.corporates') }}" class="active">Kelola Corporate</a></li>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Kelola Corporate</h1>
            @auth
