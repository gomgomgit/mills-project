...
<head>
    ...
    <title>Form Grading — Mills Smart Log</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    @livewireStyles
    <style>
        /* Design tokens — same shell pattern as resources/views/data/weighbridge-form.blade.php
           (screen-022's own #[Layout(...)] shell). This screen (screen-023)
           gets its own layout file rather than reusing screen-022's directly
...
<body>
    ...
    <div class="shell-main">
        <header class="shell-header">
            <h1 class="shell-header__title">Form Grading</h1>
            @auth
