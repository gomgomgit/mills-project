...
/**
 * Engine Room Record — log-sheet header entry for the EngineRoom station; has many EngineRoomDetail.
 *
 ...
 */
class EngineRoomRecord extends Model
{
    ...
    public function engineRoomDetails(): HasMany
    {
        return $this->hasMany(EngineRoomDetail::class);
    }
}
